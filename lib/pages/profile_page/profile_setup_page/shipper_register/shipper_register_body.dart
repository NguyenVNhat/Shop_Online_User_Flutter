...
import 'package:flutter_user_github/pages/profile_page/profile_setup_page/shipper_register/shipper_register_finish.dart';
    ...
    if (!_isChecked) {
      ...
      userController.registershipper(dto).then((status){
        if(status){
            ...
            Get.snackbar("Thông báo", "Lỗi đăng kí");
        }
      }
    );
